...
function Header() {
  return (
    <div className='flex justify-center items-center bg-white shadow-md  h-28 md:gap-16 gap-6 mt-2'>
        ...
        <div className='cursor-pointer ' >
            <div className='bg-gray-400 w-16 h-16 rounded-full  '>  
            <img className='object-cover w-full h-full rounded-full  ' src="https://rukminim2.flixcart.com/image/612/612/xif0q/sandal/q/g/j/6-svr6372kbrv-6-svaar-beige-original-imagthn6yyhnrbry.jpeg?q=70" alt="no image" />  
            </div>
        ...
        <div className='cursor-pointer ' >
            <div className='bg-gray-400 w-16 h-16   rounded-full  '>  
            <img className='object-cover  w-full h-full rounded-full  ' src="https://rukminim2.flixcart.com/image/612/612/xif0q/sandal/s/q/x/5-sl974womenflats-5-shoestail-black-original-imagxzgm2mbh7gxq.jpeg?q=70" alt="no image" />  
            </div>
        ...
        <div className='cursor-pointer ' >
            <div className='bg-gray-400 w-16 h-16 rounded-full  '>  
            <img className='object-cover w-full h-full rounded-full  ' src="https://rukminim2.flixcart.com/image/612/612/l0pm3680/regionalbooks/s/s/k/magic-practice-copybook-for-kids-4-pack-comfy-kid-handwriting-original-imagcfwhmg5ez7zz.jpeg?q=70" alt="no image" />  
            </div>
