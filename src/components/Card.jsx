...
function Card({image, title, description, price, index }) {
    // key= key;
    return (
        //     <!-- component -->
        // <!-- component -->
        <div key={index} className="flex flex-col text-gray-700 bg-white  cursor-pointer shadow-md bg-clip-border rounded-xl w-40  lg:w-72">
