  ...
  return (
    <>  
        <div className="flex justify-center content-center items-center w-96 m-2 mt-5">
          <div className="flex min-h-40 h-full w-full bg-purple-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-60 border border-gray-100
 flex-1 flex-col justify-center px-6 py-12 lg:px-8">
