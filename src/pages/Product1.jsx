...
function Product1() {
    ...
    const fetchedData = async ()=>{ 
        await fetch('https://fakestoreapi.com/products')
          ...
          .then(json=>setData(json))
           ...
           setFeatures(filtered[0])
           console.log("filtered", features.title)
      }   
      fetchedData();
  }, []);
  ...
  const handleCartButton = (e) => {
    ...
    dispatch(
      addItem({ title: features.title, price: features.price, image: features.image })
    ); // Dispatch the action with the title
  };
      ...
      <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
        ...
        <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
          ...
          <div className="py-4 border-b border-gray-200 flex items-center justify-between">
            <div class="text-base leading-4 text-gray-800 dark:text-gray-300">
              {data?.highlights?.length > 0 ? (
                data.highlights.map(
                  (highlight, index) =>
                    highlight && <div className="m-2">{highlight} </div>
                )
              ) : (
          ...
          <div className="py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center justify-center">
              <p className="text-sm leading-none text-gray-600 dark:text-gray-300 mr-3"></p>
              <svg
